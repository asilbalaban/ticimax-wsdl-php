<?php
/**
 * File for class TicimaxStructEkSecenekGrupDil
 * @package Ticimax
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TicimaxStructEkSecenekGrupDil originally named EkSecenekGrupDil
 ...
 * @date 2019-07-25
 */
class TicimaxStructEkSecenekGrupDil extends TicimaxWsdlClass
{
    /**
     * The ID
     * Meta informations extracted from the WSDL
    ...
    public $Tanim;
    /**
     * Constructor method for EkSecenekGrupDil
