<?php
/**
 * File for class TicimaxStructTeknikDetayGrupDil
 * @package Ticimax
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TicimaxStructTeknikDetayGrupDil originally named TeknikDetayGrupDil
 ...
 * @date 2019-07-25
 */
class TicimaxStructTeknikDetayGrupDil extends TicimaxWsdlClass
{
    /**
     * The ID
     * Meta informations extracted from the WSDL
    ...
    public $Tanim;
    /**
     * Constructor method for TeknikDetayGrupDil
