<?php
/**
 * File for class TicimaxStructSelectKategori
 * @package Ticimax
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TicimaxStructSelectKategori originally named SelectKategori
 ...
 * @date 2019-07-25
 */
class TicimaxStructSelectKategori extends TicimaxWsdlClass
{
    /**
     * The UyeKodu
     * Meta informations extracted from the WSDL
    ...
    public $dil;
    /**
     * Constructor method for SelectKategori
     * @see parent::__construct()
     * @param string $_uyeKodu
     * @param int $_kategoriID
     * @param string $_dil
     * @return TicimaxStructSelectKategori
     */
    public function __construct($_uyeKodu = NULL,$_kategoriID = NULL,$_dil = NULL)
    {
        parent::__construct(array('UyeKodu'=>$_uyeKodu,'kategoriID'=>$_kategoriID,'dil'=>$_dil),false);
    }
    /**
     * Get UyeKodu value
     * @return string|null
