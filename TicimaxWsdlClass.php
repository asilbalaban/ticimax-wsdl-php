<?php
/**
 * File for TicimaxWsdlClass to communicate with SOAP service
 * @package Ticimax
 ...
 */
/**
 * TicimaxWsdlClass to communicate with SOAP service
 * 
 * @package Ticimax
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2019-07-25
 */
class TicimaxWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://lorisparfum.com/Servis/UrunServis.svc?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses TicimaxWsdlClass::setLastError()
     * @uses TicimaxWsdlClass::initSoapClient()
     * @uses TicimaxWsdlClass::initInternArrayToIterate()
     * @uses TicimaxWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'TicimaxWsdlClass'))
            {
     ...
     * @uses TicimaxClassMap::classMap()
     * @uses TicimaxWsdlClass::getDefaultWsdlOptions()
     * @uses TicimaxWsdlClass::getSoapClientClassName()
     * @uses TicimaxWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('TicimaxClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = TicimaxClassMap::classMap();
     ...
     * If a class is named as {Ticimax}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('TicimaxSoapClient') && is_subclass_of('TicimaxSoapClient','SoapClient'))
            return 'TicimaxSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses TicimaxWsdlClass::WSDL_CACHE_WSDL
     * @uses TicimaxWsdlClass::WSDL_COMPRESSION
     * @uses TicimaxWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses TicimaxWsdlClass::WSDL_ENCODING
     * @uses TicimaxWsdlClass::WSDL_EXCEPTIONS
     * @uses TicimaxWsdlClass::WSDL_FEATURES
     * @uses TicimaxWsdlClass::WSDL_LOGIN
     * @uses TicimaxWsdlClass::WSDL_PASSWORD
     * @uses TicimaxWsdlClass::WSDL_SOAP_VERSION
     * @uses TicimaxWsdlClass::WSDL_STREAM_CONTEXT
     * @uses TicimaxWsdlClass::WSDL_TRACE
     * @uses TicimaxWsdlClass::WSDL_TYPEMAP
     * @uses TicimaxWsdlClass::WSDL_URL
     * @uses TicimaxWsdlClass::VALUE_WSDL_URL
     * @uses TicimaxWsdlClass::WSDL_USER_AGENT
     * @uses TicimaxWsdlClass::WSDL_PROXY_HOST
     * @uses TicimaxWsdlClass::WSDL_PROXY_PORT
     * @uses TicimaxWsdlClass::WSDL_PROXY_LOGIN
     * @uses TicimaxWsdlClass::WSDL_PROXY_PASSWORD
     * @uses TicimaxWsdlClass::WSDL_LOCAL_CERT
     * @uses TicimaxWsdlClass::WSDL_PASSPHRASE
     * @uses TicimaxWsdlClass::WSDL_AUTHENTICATION
     * @uses TicimaxWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses TicimaxWsdlClass::getSoapClient()
     * @uses TicimaxWsdlClass::getFormatedXml()
     ...
     * @uses TicimaxWsdlClass::getSoapClient()
     * @uses TicimaxWsdlClass::convertStringHeadersToArray()
     ...
     * @uses TicimaxWsdlClass::getInternArrayToIterate()
     * @uses TicimaxWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses TicimaxWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses TicimaxWsdlClass::getInternArrayToIterateOffset()
     * @uses TicimaxWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses TicimaxWsdlClass::getInternArrayToIterateOffset()
     * @uses TicimaxWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see TicimaxWsdlClass::offsetGet()
     * @uses TicimaxWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses TicimaxWsdlClass::getAttributeName()
     * @uses TicimaxWsdlClass::__toString()
     * @uses TicimaxWsdlClass::_set()
     * @uses TicimaxWsdlClass::_get()
     * @uses TicimaxWsdlClass::setInternArrayToIterate()
     * @uses TicimaxWsdlClass::setInternArrayToIterateIsArray()
     * @uses TicimaxWsdlClass::setInternArrayToIterateOffset()
