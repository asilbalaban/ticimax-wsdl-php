<?php
/**
 * File for class TicimaxStructDeleteUrunEtiket
 * @package Ticimax
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TicimaxStructDeleteUrunEtiket originally named DeleteUrunEtiket
 ...
 * @date 2019-07-25
 */
class TicimaxStructDeleteUrunEtiket extends TicimaxWsdlClass
{
    /**
     * The UyeKodu
     * Meta informations extracted from the WSDL
    ...
    public $list;
    /**
     * Constructor method for DeleteUrunEtiket
     * @see parent::__construct()
     * @param string $_uyeKodu
     * @param TicimaxStructArrayOfUrunEtiket $_list
     * @return TicimaxStructDeleteUrunEtiket
     */
