<?php
/**
 * File for class TicimaxStructUrunOdemeSecenekTaksit
 * @package Ticimax
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TicimaxStructUrunOdemeSecenekTaksit originally named UrunOdemeSecenekTaksit
 ...
 * @date 2019-07-25
 */
class TicimaxStructUrunOdemeSecenekTaksit extends TicimaxWsdlClass
{
    /**
     * The TaksitSayisi
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for UrunOdemeSecenekTaksit
     ...
     */
    public function __construct($_taksitSayisi = NULL,$_taksitTanim = NULL,$_taksitTutari = NULL,$_taksitTutariStr = NULL,$_toplamTutar = NULL,$_toplamTutarStr = NULL)
    {
        parent::__construct(array('TaksitSayisi'=>$_taksitSayisi,'TaksitTanim'=>$_taksitTanim,'TaksitTutari'=>$_taksitTutari,'TaksitTutariStr'=>$_taksitTutariStr,'ToplamTutar'=>$_toplamTutar,'ToplamTutarStr'=>$_toplamTutarStr),false);
    }
    /**
